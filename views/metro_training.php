<div id="tile">
	<a href="http://www.barnsley-ltu.co.uk/events/view/" title="See your Training Events">All Training Events</a>
	<div id="slider2" style="font-size:small;padding-top:20px">
		...
		<?php
			...
			if($events->num_rows == 0)
			{
				...
				<div>
					<a href="http://www.barnsley-ltu.co.uk/events/new/" title="Click here to create a new Training Event">Click here to create a new Training Event</a>
				</div>
				<?php
			}
			else
		...
		?>
				<div>
					<table>
							...
							?>
						<tr>
							<td><a href="http://www.barnsley-ltu.co.uk/event/<?php echo $event->id; ?>" title="Click to see this Event"><?php echo $event->title; ?></a></td>
